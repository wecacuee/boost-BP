...
/// Codomain functor
//
codomain_iter_pair binary_static_function() {
...
BinaryCodomainMapSP::value_type get(BinaryCodomainMapSP c, Vertex n) {
...
TEST(test_sumproduct, kshischang_et_al) {
  ...
  codomain_iter_pair cdip(binary_static_function());
  BinaryCodomainMapSP cdmap;
